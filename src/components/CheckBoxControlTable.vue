  ...
  <div>
    ...
    <table class="table">
      ...
      <tr>
       ...
       <tr>
        <td>Alignment</td>
        <td>
          <select :value="controlData.Alignment" >
    ...
    <tr>
      ...
      <tr>
       ...
       <tr>
        <td>SpecialEffect</td>
        <td>
          <select :value="controlData.SpecialEffect" >
    ...
    <tr>
      ...
      <tr>
        <td>TripleState</td>
        <td>
          <select :value="controlData.TripleState">
            <option :value="false">False</option>
...
export default class CheckBoxControlTable extends Vue {
